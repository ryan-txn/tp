...
public class WeightEntryDisplayTest {
    ...
    public void testShouldPrintGraph() {
        ...
        users.addUserEntry(new User(70.0, 75.0, true, 25, "WEIGHT_LOSS", 2200.0, "2024-10-28 16:34:15"));
        users.addUserEntry(new User(70.0, 74.0, true, 25, "WEIGHT_LOSS", 2200.0, "2024-10-29 16:34:15"));
        users.addUserEntry(new User(70.0, 73.5, true, 25, "WEIGHT_LOSS", 2200.0, "2024-10-30 16:34:15"));
        users.addUserEntry(new User(70.0, 72.0, true, 25, "WEIGHT_LOSS", 2200.0, "2024-10-31 16:34:15"));
        users.addUserEntry(new User(70.0, 71.0, true, 25, "WEIGHT_LOSS", 2200.0, "2024-11-01 16:34:15"));
        users.addUserEntry(new User(70.0, 70.0, true, 25, "WEIGHT_LOSS", 2200.0, "2024-11-02 16:34:15"));
